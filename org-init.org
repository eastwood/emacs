...
* Ace Window
I usually don't have many split windows, but ace makes it super convenient to navigate around windows and frames
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
* TODO Layouts Mode (persp-mode)
* TODO Company Mode
* TODO Snippets (ya-snippets)
* TODO Expand Region
* TODO JS-Comint
* Helper Functions
#+BEGIN_SRC emacs-lisp
